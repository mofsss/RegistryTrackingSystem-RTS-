...
$req2 = mysqli_query($con,'SELECT pm.timestamp, pm.message, users.id AS userid, users.username FROM pm, users WHERE pm.id="'.$id.'" and users.id=pm.user1 order by pm.id2');
